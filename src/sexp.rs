...
pub type SourceDoucument = Document<PathBuf>;
...
pub type SourceItem = Item<PathBuf>;
...
impl<R: Read> ParseCtx<R> {
    ...
    fn parse_root(&mut self) -> ParseResult<Document<PathBuf>> {
    ...
    fn parse_image_items(&mut self) -> ParseResult<ImageItem<PathBuf>> {
